...
# data = read.csv("~/Project9_chemical_sens/data/working data/v0/fT3_imp.csv")
data = read.csv("data/v0/fT3_imp.csv")
...
#                                            g_max = g_max, seed = 518, uk = uk)
save("cluster_ahei",file = "data/v0/fT3_imp_ahei.Rdata")
...
save("cluster_dash", file = "data/v0/fT3_imp_dash.Rdata")
...
#                                            g_max = g_max, seed = 518)
save("cluster_amed", file = "data/v0/fT3_imp_amed.Rdata")
